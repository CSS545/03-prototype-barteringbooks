...
const socket = io('http://10.156.11.112:3001')
...
const MessagePage = ({ navigation, route }) => {
    ...
    const loaddata = async () => {
        AsyncStorage.getItem('user')
            .then(async (value) => {
                fetch('http://10.156.11.112:3000/userdata', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(res => res.json()).then(data => {
                        if (data.message == 'User Found') {
                            ...
                            fetch('http:10.156.11.112:3000/otheruserdata', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
    ...
    const sendMessage = async () => {
        ...
        fetch('http://10.156.11.112:3000/savemessagetodb', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const loadMessages = (temproomid) => {
        fetch('http://10.156.11.112:3000/getmessages', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
